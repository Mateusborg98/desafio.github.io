	var init = function(){
	      ...
	      let initOptions = {
	        'apikey': 'AIzaSyA8TJc1vVfphx306t1AleLcAhrFFQ47_ik',
	        'clientId' : '452342451928-cq344osksmvf520sl7rijhi951fuddms.apps.googleusercontent.com',
	        'scope' : 'profile email',
	      };
	    ...
	    var updateSigninStatus = (isSignedIn) => { if(isSignedIn){
	    	 signUpWithGoogle().then((response)=>{
	                       ...
	                       $("[name='fname'").val(response.names[0].displayNameFirst.split(" ")[0]);
